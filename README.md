...
- **Transport**: MCP over stdio (55 tools in the default workflow profile, 85 in the diagnostic profile — see `PROVENANCE.md`) + CLI (`tv` command, 30 commands with 66 subcommands)
