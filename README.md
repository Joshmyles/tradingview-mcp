...
- **Transport**: MCP over stdio (61 tools in the default workflow profile, 91 in the diagnostic profile — see `PROVENANCE.md`) + CLI (`tv` command, 30 commands with 66 subcommands)
